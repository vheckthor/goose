...
impl ExtensionManager {
    ...
    pub async fn add_extension(&mut self, config: ExtensionConfig) -> ExtensionResult<()> {
        ...
        tracing::debug!("ADDING EXTENSION in add_extension in extension_manager.rs: {}", sanitized_name);
        ...
        tracing::debug!("SUCCESSFULLY ADDED EXTENSION in add_extension in extension_manager.rs: {}", sanitized_name);
        Ok(())
    }
