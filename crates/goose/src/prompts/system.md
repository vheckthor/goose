...
Use your discover_extensions tool if needed to discover more extensions that might be helpful for solving the current task and suggesting to the user that they enable the extension for you.
