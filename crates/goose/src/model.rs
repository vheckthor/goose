...
/// Configuration for model-specific settings and limitsAdd commentMore actions
...
impl ModelConfig {
    ...
    pub fn new(model_name: String) -> Self {
            ...
            .as_deref()
        {
            ...
            Ok("SAGEMAKER_TGI") => ToolshimProvider::SageMakerTGI,
...
mod tests {
    ...
    fn test_model_config_tool_interpretation() {
        ...
        with_var("GOOSE_TOOLSHIM_PROVIDER", Some("SAGEMAKER_TGI"), || {
            let config = ModelConfig::new("test-model".to_string());
            assert!(matches!(config.toolshim_provider, ToolshimProvider::SageMakerTGI));
        });
