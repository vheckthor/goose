              ...
              <section id="models">
                ...
                <div className="px-8">
                      ...
                      <React.Fragment key={model.id}>
                        <div className="flex items-center justify-between py-3">
                          ...
                          <input
                            ...
                            className="h-4 w-4 text-indigo-500 border-borderSubtle focus:ring-indigo-500"
                          />
                        </div>
                  ...
                  <div className="flex gap-4 pt-4 w-full">
                    ...
                    <Button className="flex items-center gap-2 flex-1 justify-center border-standard bg-grey-60 hover:bg-subtle">
                      <Gear className="h-4 w-4" />
                      Configure Providerss
                    </Button>
                  </div>
                </div>
              </section>
              ...
              <section id="extensions">
                ...
                <div className="px-8">
                  ...
                  <div className="flex gap-4 pt-4 w-full">
                    ...
                    <Button
                      className="flex items-center gap-2 flex-1 justify-center border-standard bg-grey-60 hover:bg-subtle"
                      onClick={() =>
